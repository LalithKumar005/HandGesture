...
r=''
flag=0
firebase = firebase.FirebaseApplication("https://myapplication-fc320.firebaseio.com", None)

def sendToFirebase(text):
    f = open("./chatParticipants.txt",'r')

    chat = f.read()

    f.close()

    result = firebase.post(url='/messages/'+chat, data={'message':text, 'user':chat.split('_')[0]})
...
def main():
    ...
    #Get from IPcamera
    #hardcoded URL - 
    url='http://172.17.9.111:8080/shot.jpg'
    import requests
